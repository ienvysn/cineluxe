  ...
  if (!bookingData) {
    return (
      <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6 text-center animate-fade-in">
        <div className="w-24 h-24 rounded-3xl bg-destructive/10 border border-destructive/20 flex items-center justify-center mb-8"></div>
        <h2 className="text-3xl font-display font-bold text-white mb-3 tracking-tighter uppercase italic">
          Session Expired
        </h2>
        <p className="text-muted-foreground mb-10 max-w-sm font-light leading-relaxed italic">
          The cinematic experience could not be verified. Your journey starts
          back at the premiere gallery.
        </p>
        <Link to="/">
        ...
        <div className="glass-card overflow-hidden border-white/5 shadow-2xl bg-gradient-to-b from-white/[0.05] to-transparent rounded-[32px]">
          <div className="p-10 text-center border-b border-white/5">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-success/10 border border-success/20 mb-4 animate-slide-up">
              <span className="text-[10px] font-bold uppercase tracking-[3px] text-success">
                Order Finalized
              </span>
            </div>
          ...
          <div className="p-10 space-y-8 relative">
            <div className="grid grid-cols-2 gap-4">
              <div
                className="p-5 rounded-2xl bg-white/5 border border-white/5 hover:border-white/10 transition-all cursor-pointer"
                onClick={() => copyToClipboard(displayId, "Booking Number")}
              >
                <p className="text-[9px] text-muted-foreground uppercase tracking-widest mb-2 font-bold opacity-50">
                  Booking Number
                </p>
              ...
              <div
                className="p-5 rounded-2xl bg-primary/5 border border-primary/20 hover:bg-primary/10 transition-all cursor-pointer"
                onClick={() => copyToClipboard(pin, "Access PIN")}
              >
                <p className="text-[9px] text-primary uppercase tracking-widest mb-2 font-bold opacity-70 italic">
                  Gate Access PIN
                </p>
                <div className="flex items-center justify-between">
                  <p className="font-mono text-2xl font-black text-primary tracking-tight">
                    {pin}
                  </p>
              ...
              <div className="flex-1">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2 text-xs text-muted-foreground">
                    ...
                    <span className="font-display font-medium text-white italic">
                      {showtime.time}
                    </span>
                  </div>
                </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between px-1">
                ...
                <span className="text-[10px] font-black text-white px-2 py-0.5 rounded-md bg-primary/20 border border-primary/20">
              ...
              <div className="flex flex-wrap gap-2">
                {seats.map((seat) => (
                  <span
                    key={seat}
                    className="px-4 py-2 bg-white/5 border border-white/5 hover:border-primary/30 transition-colors rounded-xl text-xs font-bold font-mono text-white"
                  >
                    {seat}
                  </span>
                ))}
            ...
            <div className="flex justify-between items-end pt-6 border-t border-white/5">
              <div className="space-y-1">
                <p className="text-[9px] uppercase tracking-widest text-muted-foreground font-bold opacity-50 italic">
                  Total Consideration
                </p>
                <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 w-fit">
                  <div className="w-1 h-1 rounded-full bg-success animate-pulse" />
                  <span className="text-[9px] uppercase font-bold text-success/80 tracking-widest">
                    {paymentMethod}
                  </span>
                </div>
              </div>
              <p className="text-4xl font-display font-black text-white italic tracking-tighter uppercase">
          ...
          <div className="p-10 pt-4 flex flex-col sm:flex-row gap-4">
            <Link to="/bookings" className="flex-1">
              <Button
                variant="gold"
                size="xl"
                className="w-full h-14 rounded-2xl uppercase tracking-widest text-[10px] font-bold"
              >
                My Bookings
              </Button>
            </Link>
            <Link to="/" className="flex-1">
              <Button
                variant="outline"
                size="xl"
                className="w-full h-14 rounded-2xl uppercase tracking-widest text-[10px] font-bold border-white/10 bg-white/5"
              >
                New Experience
              </Button>
            </Link>
