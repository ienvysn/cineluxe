  ...
  const BookingCard = ({ booking }) => (
    <div className="group relative overflow-hidden rounded-3xl bg-card/40 border border-white/5 backdrop-blur-md transition-all duration-500 hover:border-primary/30 hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.8)]">
        ...
        <div className="flex-1 min-w-0 flex flex-col justify-between">
          ...
          <div className="flex flex-wrap items-center gap-6 mt-6 pt-4 border-t border-white/5">
            <div className="flex flex-col">
              <span className="text-[10px] uppercase tracking-widest text-muted-foreground mb-1 font-bold">
                Booking ID
              </span>
            ...
            <div className="flex flex-col">
              <span className="text-[10px] uppercase tracking-widest text-primary mb-1 font-bold">
                Access PIN
              </span>
              <span className="font-mono text-xl text-primary font-black tracking-tighter">
                {booking.pin}
              </span>
            </div>
          </div>
      ...
      <div className="flex items-center justify-between p-6 bg-white/[0.02] border-t border-white/5">
        <div className="flex flex-col">
          <span className="text-[10px] uppercase tracking-[2px] text-muted-foreground font-bold">
            Premium Ticket
          </span>
        ...
        canCancel(booking.date, booking.time) ? (
          <Button
            variant="ghost"
            size="sm"
            className="text-destructive/60 hover:text-destructive hover:bg-destructive/10 transition-colors font-bold uppercase tracking-widest text-[10px]"
          >
            Void Ticket
          </Button>
        ) : (
          <Button
            ...
            variant="outline"
            size="sm"
            className="opacity-30 border-white/10 text-[10px] uppercase tracking-widest"
          >
            Non-Refundable
          </Button>
        )}
