        ...
        <div className="glass-card p-10 relative overflow-hidden border-white/5 shadow-2xl">
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground mt-3 font-light">
              Please sign in to manage your cinema.
            </p>
          </div>
          ...
          <div className="mt-8 pt-6 border-t border-white/5 flex flex-col items-center gap-2">
            <p className="text-[9px] text-muted-foreground uppercase tracking-[2px] font-bold">
              Demo Credentials
            </p>
            <div className="flex gap-4">
              ...
              <div className="text-[10px] text-muted-foreground">
                <span className="text-primary font-bold">Pass:</span> admin123
              </div>
            </div>
          </div>
        </div>
