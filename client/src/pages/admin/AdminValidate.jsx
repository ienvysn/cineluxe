  ...
  const handleValidate = async () => {
    ...
    try {
      ...
      toast.success("Ticket Validated", {
        description:
          "Ticket has been successfully verified and marked as used.",
      });
    } catch (error) {
    ...
    <div className="space-y-12 animate-fade-in max-w-5xl mx-auto">
      ...
      <div className="text-center">
        <div className="inline-flex items-center gap-2 mb-6">
          ...
          <span className="text-[10px] uppercase tracking-[4px] text-primary font-bold">
            Ticket Check
          </span>
        </div>
        ...
        <p className="text-muted-foreground mt-4 font-light text-xl max-w-2xl mx-auto">
          Check-in customers by their Booking ID and PIN.
        </p>
      </div>
          ...
          <div className="flex gap-4 relative z-10">
            ...
            {validationResult !== "idle" && (
              <Button
                ...
                size="xl"
                onClick={handleReset}
                className="h-16 px-8 rounded-2xl border-white/10 uppercase tracking-widest text-[10px] font-bold"
              >
                Clear
              </Button>
            )}
        ...
        {validationResult !== "idle" && resultDisplay && (
          ...
          >
            <div className="flex items-start gap-6 mb-10 relative z-10">
              <div
                className={cn(
                  "p-4 rounded-2xl bg-black/20 shadow-xl border border-white/5",
                  resultDisplay.iconColor,
                )}
              >
              ...
              <div>
                ...
                <p className="text-muted-foreground font-light text-lg italic leading-relaxed">
                      ...
                      <div className="flex flex-col md:flex-row gap-8 p-8 bg-black/40 rounded-[32px] border border-white/5 shadow-inner">
                        ...
                        <div className="flex-1 flex flex-col justify-center">
                          <div className="flex items-center gap-2 mb-2">
                            <Badge
                              variant="goldOutline"
                              className="px-3 py-0.5 text-[8px] font-bold uppercase tracking-widest"
                            >
                              {screen?.name || "Screen"}
                            </Badge>
                          </div>
                          <h4 className="font-display text-4xl font-bold text-white italic tracking-tighter mb-2">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="p-6 rounded-[24px] bg-black/20 border border-white/5 flex flex-col gap-2">
                          ...
                          <span className="text-xl font-mono font-bold text-white italic">
                            {foundBooking.bookingNumber || foundBooking.id}
                          </span>
                        </div>
                        <div className="p-6 rounded-[24px] bg-black/20 border border-white/5 flex flex-col gap-2">
        ...
        {validationResult === "idle" && (
          <div className="mt-10 text-center py-20 bg-white/[0.02] border border-dashed border-white/10 rounded-[40px]">
            ...
            <p className="text-muted-foreground italic text-sm">
              Enter booking details above to verify tickets.
            </p>
          </div>
        )}
      </div>
