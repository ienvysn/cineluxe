          ...
          <div className="h-24 px-6 border-b border-white/5 flex items-center justify-between">
            <div className={cn("flex items-center gap-3 transition-opacity duration-300", !isSidebarOpen && "lg:opacity-0")}>
              ...
              <span className="font-display font-bold text-xl tracking-tight text-white whitespace-nowrap">
                Cine<span className="text-primary italic">Luxe</span> <span className="text-[10px] uppercase tracking-widest text-muted-foreground ml-1 font-bold">Admin</span>
              </span>
            </div>
            <button
            ...
            {navItems.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  <item.icon className={cn("w-5 h-5 flex-shrink-0 transition-transform duration-300 group-hover:scale-110", isActive && "text-primary")} />
                  {isSidebarOpen && (
      ...
      <main className="flex-1 min-w-0 bg-[#030303] overflow-y-auto h-screen custom-scrollbar relative">
        ...
        <header className="lg:hidden sticky top-0 z-30 bg-background/80 backdrop-blur-xl border-b border-white/5 p-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-display font-bold text-lg">Cine<span className="text-primary italic">Luxe</span></span>
          </div>
          <div className="w-10" />
        </header>
